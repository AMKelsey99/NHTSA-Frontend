This is the HTML frontend of the NHTSA project that collects data from the NHTSA API using an AWS Lambda script, and stores it in an RDS-hosted MySQL database. 
